...
const task_reaction_info = {
  space_main: _.flattenDeep(magpieUtils.views.loop([canvas_dict.reaction.circle, canvas_dict.reaction.square], 10)),
  space_practice: _.flattenDeep(magpieUtils.views.loop([canvas_dict.reaction_p.circle, canvas_dict.reaction_p.square], 3))
}

const task_goNoGo_info = {
  goNoGo_main: _.flattenDeep(magpieUtils.views.loop([canvas_dict.goNoGo.circle, canvas_dict.goNoGo.square], 10)),
  goNoGo_practice: _.flattenDeep(magpieUtils.views.loop([canvas_dict.goNoGo_p.circle, canvas_dict.goNoGo_p.square], 3))
}

const task_discrimination_info = {
  keyPress_main: _.flattenDeep(magpieUtils.views.loop([canvas_dict.keyPress.circle, canvas_dict.keyPress.square], 10)),
  keyPress_practice: _.flattenDeep(magpieUtils.views.loop([canvas_dict.keyPress.circle, canvas_dict.keyPress.square], 3))
